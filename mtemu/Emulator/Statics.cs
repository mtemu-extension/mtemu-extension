...
namespace mtemu
{
    ...
    partial class Emulator
    {
        ...
        public static Dictionary<int, Tuple<string, int>> mapJumps_ => new Dictionary<int, Tuple<string, int>>
        {
            ...
            {7, new Tuple<string, int>("UART LOAD", 0xf0b) },
            {8, new Tuple<string, int>("SPI LOAD", 0xf0f) },
            {9, new Tuple<string, int>("I2C LOAD", 0xf13) },
            {10, new Tuple<string, int>("GPIO LOAD", 0xf17) },
            {11, new Tuple<string, int>("UART READ", 0xf1b) },
            {12, new Tuple<string, int>("SPI READ", 0xf1f) },
            {13, new Tuple<string, int>("I2C READ", 0xf23) },
            {14, new Tuple<string, int>("GPIO READ", 0xf27) },
        };
