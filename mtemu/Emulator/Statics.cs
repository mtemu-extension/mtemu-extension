...
namespace mtemu
{
    ...
    partial class Emulator
    {
        ...
        public static List<Command> callCommands => new List<Command>
        {
            ...
            // SPI LOAD
            new Command(
                new string[] {"1111", "0001", "1010", "0000", "0000", "0000", "0000", "0000", "0000", "0000"},
                true
                ),
             new Command(
                new string[] {"0000", "0000", "0000", "0010", "0001", "0000", "1011", "0000", "0000", "0000"}
            ...
            // I2C LOAD
            new Command(
                new string[] {"1111", "0001", "1110", "0000", "0000", "0000", "0000", "0000", "0000", "0000"},
                true
                ),
             new Command(
                new string[] {"0000", "0000", "0000", "0010", "0001", "0000", "1011", "0000", "0000", "0000"}
            ...
            // GPIO LOAD
            new Command(
                new string[] {"1111", "0010", "0010", "0000", "0000", "0000", "0000", "0000", "0000", "0000"},
                true
                ),
             new Command(
                new string[] {"0000", "0000", "0000", "0010", "0001", "0000", "1011", "0000", "0000", "0000"}
            ...
            // UART READ
            new Command(
                new string[] {"1111", "0010", "0110", "0000", "0000", "0000", "0000", "0000", "0000", "0000"},
                true
                ),
            new Command(
                new string[] {"0000", "0000", "0000", "0010", "0001", "0000", "1011", "0000", "0000", "0000"}
